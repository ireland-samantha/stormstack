...
Examples:
  thunder cluster status
  thunder cluster status -o json`,
...
Examples:
  thunder cluster nodes
  thunder cluster nodes -o json
  thunder cluster nodes -o quiet`,
...
Examples:
  thunder cluster node node-1
  thunder cluster node node-1 -o json`,
