...
Examples:
  thunder config get control_plane_url
  thunder config get auth_url
  thunder config get output_format`,
...
var configSetCmd = &cobra.Command{
	...
	Long: `Set a configuration value and save to ~/.thunder.yaml.
...
Examples:
  thunder config set control_plane_url http://localhost:8081
  thunder config set auth_url http://localhost:8082
  thunder config set output_format json
  thunder config set auth_token my-secret-token`,
