...
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.domain.CollisionHandlerConfig;
...
import static ca.samanthaireland.stormstack.thunder.engine.ext.modules.BoxColliderModuleFactory.*;
...
public class EcsBoxColliderRepository implements BoxColliderRepository {
    ...
    public float getPositionX(long entityId) {
        return store.getComponent(entityId, ca.samanthaireland.stormstack.thunder.engine.ext.modules.GridMapModuleFactory.POSITION_X);
    }

    @Override
    public float getPositionY(long entityId) {
        return store.getComponent(entityId, ca.samanthaireland.stormstack.thunder.engine.ext.modules.GridMapModuleFactory.POSITION_Y);
    }
