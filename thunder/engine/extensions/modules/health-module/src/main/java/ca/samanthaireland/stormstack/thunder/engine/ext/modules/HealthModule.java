...
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.domain.repository.HealthRepository;
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.domain.service.HealthService;
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.ecs.command.AttachHealthCommand;
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.ecs.command.DamageCommand;
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.ecs.command.HealCommand;
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.ecs.command.SetInvulnerableCommand;
import ca.samanthaireland.stormstack.thunder.engine.ext.modules.ecs.repository.EcsHealthRepository;

import java.util.List;

import static ca.samanthaireland.stormstack.thunder.engine.ext.modules.HealthModuleFactory.ALL_COMPONENTS;
import static ca.samanthaireland.stormstack.thunder.engine.ext.modules.HealthModuleFactory.FLAG;
