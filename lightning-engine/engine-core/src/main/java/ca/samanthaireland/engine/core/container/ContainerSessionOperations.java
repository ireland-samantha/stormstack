...
public interface ContainerSessionOperations {
     ...
     * @throws ca.samanthaireland.engine.core.exception.EntityNotFoundException if player doesn't exist in this container
     * @throws ca.samanthaireland.engine.core.exception.ConflictException if player already has an active session
     */
     ...
     * @throws ca.samanthaireland.engine.core.exception.EntityNotFoundException if no session exists
