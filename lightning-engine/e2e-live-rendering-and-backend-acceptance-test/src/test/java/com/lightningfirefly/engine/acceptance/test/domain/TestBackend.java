...
public class TestBackend {
    ...
    // Package-private accessors for domain classes
    MatchAdapter matchAdapter() { return matchAdapter; }
    CommandAdapter commandAdapter() { return commandAdapter; }
    SnapshotAdapter snapshotAdapter() { return snapshotAdapter; }
    SimulationAdapter simulationAdapter() { return simulationAdapter; }
    ...
    public static class MatchBuilder {
         ...
         *
         * @param moduleName the module name (e.g., "SpawnModule", "RenderModule")
