...
public class Match {
     ...
     */
    public SnapshotParser fetchSnapshot() {
        try {
            return backend.snapshotAdapter().getMatchSnapshot(matchId)
    ...
    public static class SpawnEntityBuilder {
        ...
        public Entity execute() {
            ...
            List<Float> existingIds = beforeSnapshot.getComponent("EntityModule", "ENTITY_ID");
            ...
            List<Float> afterIds = afterSnapshot.getComponent("EntityModule", "ENTITY_ID");
