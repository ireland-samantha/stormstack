...
public class SnapshotAssertions {
    ...
    /**
     * Get component values directly for the current module.
     *
     * @param componentName the component name
     * @return list of component values
     */
    public List<Float> getComponent(String componentName) {
        if (currentModule == null) {
            throw new IllegalStateException("Must call hasModule() before getComponent()");
        }
        return parser.getComponent(currentModule, componentName);
    }
    ...
    public static class ComponentAssertions {
        ...
        /**
         * Apply a custom assertion on the component values.
         *
         * @param assertion the custom assertion to apply
         * @return the parent SnapshotAssertions for chaining
         */
        public SnapshotAssertions satisfying(Consumer<List<Float>> assertion) {
