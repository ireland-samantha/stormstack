...
class SpawnEntitiyVerifySnapshotIT {
    ...
    @Test
    @DisplayName("Given a match with SpawnModule, when spawning an entity and ticking, then entity appears in snapshot")
    void givenMatchWithSpawnModule_whenSpawningEntityAndTicking_thenEntityAppearsInSnapshot() {
        // Given a match with SpawnModule
    ...
    void givenMatchWithRenderModule_whenCreatingWithoutIdField_thenMatchIsCreatedSuccessfully() {
        // When creating a match with SpawnModule and RenderModule
        match = backend.createMatch()
