...
class SnapshotParserTest {
    ...
    private static final String FULL_SNAPSHOT_JSON = """
            {"matchId":1,"tick":3,"data":{"EntityModule":{"ENTITY_ID":[1.0],"ENTITY_TYPE":[100.0],"OWNER_ID":[1.0],"PLAYER_ID":[1.0]},"CheckersModule":{"ENTITY_ID":[1.0]},"RenderModule":{"ENTITY_ID":[1.0],"RESOURCE_ID":[1.0]},"MoveModule":{"ENTITY_ID":[1.0],"VELOCITY_X":[0.0],"VELOCITY_Y":[0.0],"VELOCITY_Z":[0.0],"POSITION_X":[200.0],"POSITION_Y":[150.0],"POSITION_Z":[0.0],"move":[1.0]}}}
            """;

    private static final String MULTI_ENTITY_JSON = """
            {"matchId":1,"tick":5,"data":{"EntityModule":{"ENTITY_ID":[1.0,2.0,3.0],"ENTITY_TYPE":[100.0,101.0,102.0]},"MoveModule":{"ENTITY_ID":[1.0,2.0,3.0],"POSITION_X":[100.0,200.0,300.0],"POSITION_Y":[50.0,150.0,250.0]}}}
            """;
    ...
    class ModuleParsing {
        ...
        void parseAllModules() {
            ...
            assertThat(parser.getModuleNames()).containsExactlyInAnyOrder(
                    "EntityModule", "CheckersModule", "RenderModule", "MoveModule");
        }
        ...
        void detectModuleExistence() {
            ...
            assertThat(parser.hasModule("EntityModule")).isTrue();
    ...
    class ComponentExtraction {
        ...
        @Test
        @DisplayName("should get ENTITY_ID from EntityModule")
        void getEntityIdFromEntityModule() {
            SnapshotParser parser = SnapshotParser.parse(FULL_SNAPSHOT_JSON);

            List<Float> entityIds = parser.getComponent("EntityModule", "ENTITY_ID");
        ...
        void returnEmptyForNonExistentComponent() {
            ...
            List<Float> missing = parser.getComponent("EntityModule", "NON_EXISTENT");
    ...
    class SingleValueExtraction {
        ...
        void returnEmptyForMissingValue() {
            ...
            assertThat(parser.getComponentValue("EntityModule", "MISSING"))
                    .isEmpty();
        }
