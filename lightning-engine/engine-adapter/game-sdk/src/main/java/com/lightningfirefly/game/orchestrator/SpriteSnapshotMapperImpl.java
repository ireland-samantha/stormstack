 ...
 * that can be rendered. It provides sensible defaults configured for RenderModule's
 * SPRITE_ prefixed component names and is configurable for different naming conventions.
 *
 * <p>Default component names (matching RenderModule):
 * <ul>
 *   <li>SPRITE_X, SPRITE_Y - display position</li>
 ...
 * }</pre>
 *
 * <p>To use with MoveModule's position components instead:
 * <pre>{@code
 * SpriteSnapshotMapperImpl mapper = new SpriteSnapshotMapperImpl()
...
public class SpriteSnapshotMapperImpl implements SpriteSnapshotMapper {
    ...
    // Component name configuration - defaults to RenderModule's SPRITE_ prefixed names
    private String entityIdComponent = "ENTITY_ID";
    private String positionXComponent = "SPRITE_X";
    private String positionYComponent = "SPRITE_Y";
