...
For engine node module operations, use 'lightning node module'.
...
Examples:
  lightning module upload EntityModule 1.0.0 ./entity-module.jar
  lightning module upload RigidBodyModule 1.0.0 ./rigid-body-module-1.0.0.jar --description "Physics simulation"`,
