...
import {
    Add as AddIcon, Delete as DeleteIcon, Edit as EditIcon, Refresh as RefreshIcon, VpnKey as PasswordIcon
} from "@mui/icons-material";
import {
    Alert, Autocomplete, Box, Button,
    Chip,
    CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, FormControlLabel, IconButton, Paper, Switch, Table,
    TableBody,
    TableCell,
    TableContainer,
    TableHead,
...
import {
    useCreateUserMutation, useDeleteUserMutation, useGetRolesQuery, useGetUsersQuery, UserData, useSetUserEnabledMutation,
  ...
  const handleSaveUser = async () => {
    try {
      if (editingUser) {
        ...
        if (
          JSON.stringify(editingUser.roles) !== JSON.stringify(formData.roles)
        ) {
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            variant="contained"
            disabled={
              !formData.username || (!editingUser && !formData.password)
            }
          >
            Save
          </Button>
