...
**StormStack** is a production-grade multi-match game server framework consisting of:
...
.. note::
   ...
   This documentation covers StormStack version 2.0.0. A Rust rewrite is in progress
   but the stable Java/Go implementation documented here is production-ready.
