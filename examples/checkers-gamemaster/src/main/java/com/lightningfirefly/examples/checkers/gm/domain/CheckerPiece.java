...
/**
 * Server-side domain object representing a checker piece.
 *
 * <p>Used by the GameMaster to track piece state. The setters are
 * used directly to update state, and changes are propagated to
 * the ECS via commands.
 */
@Getter
@Setter
