...
class SpriteSnapshotMapperImplTest {
        ...
        void mapsMultipleEntities() {
            Snapshot snapshot = createSnapshot(Map.of(
                    "TestModule", Map.of(
                            ...
                            "POSITION_X", List.of(100.0f, 200.0f, 300.0f),
                            "POSITION_Y", List.of(50.0f, 60.0f, 70.0f)
                    )
            ));
    ...
    class SizeAndRotation {
        ...
        @Test
        @DisplayName("maps custom size components")
        void mapsCustomSize() {
            Snapshot snapshot = createSnapshot(Map.of(
                    "TestModule", Map.of(
                            "ENTITY_ID", List.of(1.0f),
                            "SIZE_X", List.of(64.0f),
                            "SIZE_Y", List.of(32.0f)
                    )
            ));
        ...
        @Test
        @DisplayName("maps rotation")
        void mapsRotation() {
            Snapshot snapshot = createSnapshot(Map.of(
                    "TestModule", Map.of(
                            "ENTITY_ID", List.of(1.0f),
                            "ROTATION", List.of(45.0f)
                    )
            ));
    ...
    class ZIndexAndVisibility {
        ...
        @Test
        @DisplayName("maps z-index")
        void mapsZIndex() {
            Snapshot snapshot = createSnapshot(Map.of(
                    "TestModule", Map.of(
                            "ENTITY_ID", List.of(1.0f),
                            "Z_INDEX", List.of(5.0f)
                    )
            ));
        ...
        @Test
        @DisplayName("maps visibility")
        void mapsVisibility() {
            Snapshot snapshot = createSnapshot(Map.of(
                    "TestModule", Map.of(
                            "ENTITY_ID", List.of(1.0f, 2.0f),
                            "VISIBLE", List.of(1.0f, 0.0f)
                    )
            ));
