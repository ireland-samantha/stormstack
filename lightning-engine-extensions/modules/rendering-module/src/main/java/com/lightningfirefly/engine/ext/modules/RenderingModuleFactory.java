...
public class RenderingModuleFactory implements ModuleFactory {
    ...
    public static class RenderModule implements EngineModule {
        ...
        // Note: Sprite position comes from EntityModule's POSITION_X/POSITION_Y components
        // which are shared with physics. No separate sprite position components needed.
     ...
     *
     * <p>When executed, this command attaches sprite rendering components to the specified entity,
     * including size, rotation, z-index, visibility, and resource ID.
     *
     * <p>Note: Sprite position comes from EntityModule's POSITION_X/POSITION_Y components,
     * which are shared with physics. This allows physics to update sprite positions automatically.
     *
    ...
    public static class AttachSpriteEngineCommand implements EngineCommand {
        ...
        public void executeCommand(CommandPayload payload) {
            ...
            // Attach sprite components (position comes from EntityModule)
