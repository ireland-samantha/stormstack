...
import static ca.samanthaireland.engine.ext.modules.BoxColliderModuleFactory.*;
...
public class EcsBoxColliderRepository implements BoxColliderRepository {
    ...
    public float getPositionX(long entityId) {
        return store.getComponent(entityId, ca.samanthaireland.engine.ext.modules.GridMapModuleFactory.POSITION_X);
    }

    @Override
    public float getPositionY(long entityId) {
        return store.getComponent(entityId, ca.samanthaireland.engine.ext.modules.GridMapModuleFactory.POSITION_Y);
    }
